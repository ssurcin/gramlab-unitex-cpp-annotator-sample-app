...
namespace unitexcpp
{
	...
	namespace annotation
	{
		...
		bool TransductionOutputAnnotation::isTransductionOutputAnnotation(AnnotationFS const& crAnnotation)
		{
			return crAnnotation.getType() == tTransductionOutputAnnotation;
		}
		...
		Type TransductionOutputAnnotation::getType()
		{
			return tTransductionOutputAnnotation;
		}
